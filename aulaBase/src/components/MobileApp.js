...
const MobileApp = () => {
  ...
  return (
    <View style={{ flex: 1, position: 'relative' }}>
      <HeaderMobile title="JJK Control" onToggleMenu={() => setMenuOpen(!menuOpen)} />

      <View style={[styles.content, menuOpen && styles.contentDisabled]}>
        {renderContent()}
      </View>
        ...
        <TouchableWithoutFeedback>
          <View style={styles.menuPanel}>
            <View style={styles.menuHeader}>
              ...
              <Text style={styles.menuHeaderSubtitle}>Navegação</Text>
            </View>
              ...
              {MENU_ITEMS.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isActive && <View style={styles.menuItemIndicator} />}
                  </Pressable>
                );
              })}
            </ScrollView>
